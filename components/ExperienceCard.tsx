...
export default function ExperienceCard({ title, localization, langages, dateStart, dateStop, details, src }: {
  ...
  return (
    <article className='flex flex-col rounded-xl items-center md:space-y-7 flex-shrink-0 w-full md:w-1/2 xl:w-[32%] snap-center bg-[#424242] p-10 opacity-40 hover:opacity-100 cursor-pointer transition-opacity duration-200 overflow-hidden mx-auto'>
         <Image
        ...
        >
            ...
            <div className='overflow-auto max-h-64 md:max-h-40 sm:max-h-full scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#139902]'>
