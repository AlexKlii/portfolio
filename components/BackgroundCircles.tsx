...
export default function BackgroundCircles() {
  return (
    ...
    >
      ...
      <div className='absolute border dark:border-green border-yellow-light rounded-full h-[355px] w-[355px] mt-52 animate-ping opacity-10'></div>
      <div className='absolute border dark:border-green border-yellow-light rounded-full h-[420px] w-[420px] mt-52 animate-pulse'></div>
      <div className='absolute border dark:border-green border-yellow-light rounded-full h-[710px] w-[710px] mt-52 animate-pulse opacity-10'></div>
    </motion.div>
  )
}