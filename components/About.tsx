...
export default function AboutComponent({ about, src }: { about: string, src: string }) {
  return (
    ...
    >
        <h3 className='absolute top-24 uppercase tracking-[20px] dark:text-gray-500 text-white text-2xl pl-10'>About</h3>
        ...
        <div className='space-y-10 px-0 md:px-10 absolute top-40 sm:top-2/4 xl:top-2/3 text-center'>
