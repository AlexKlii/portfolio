  ...
  return (
    ...
    >
        ...
        <div className='space-y-10 px-0 md:px-10 absolute top-1/3 sm:top-2/4 xl:top-2/3 text-center'>
            ...
            <p className='text-sm text-left md:text-center px-4 overflow-y-scroll max-h-72 md:max-h-full sm:overflow-auto scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-green font-semibold' dangerouslySetInnerHTML={{ __html: about }} />
        </div>
    </motion.div>
  )
}